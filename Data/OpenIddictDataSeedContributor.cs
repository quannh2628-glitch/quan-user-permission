...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("ABPPermission") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "ABPPermission",
                DisplayName = "ABPPermission API",
                Resources =
                {
                    "ABPPermission"
                }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Angular Client
        var consoleAndAngularClientId = configurationSection["ABPPermission_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["ABPPermission_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["ABPPermission_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["ABPPermission_Swagger:RootUrl"].TrimEnd('/');
