...
public class ABPPermissionDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ABPPermissionDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
